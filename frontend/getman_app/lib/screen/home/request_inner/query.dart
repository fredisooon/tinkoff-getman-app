...
class RequestQueryPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _RequestQueryState();
...
class _RequestQueryState extends ConsumerState<RequestQueryPage> with AutomaticKeepAliveClientMixin<RequestQueryPage> {
  FormGroup get _parentFormGroup => ReactiveForm.of(context)! as FormGroup;
  FormArray<Object?> get _formArray =>
    _parentFormGroup.control('query') as FormArray<Object?>;
  ...
  Future<void> loadData() async {
    final queryPairs = await ref.read(requestQueryProvider(widget.id).future) ?? [];
  ...
  @override
  void didUpdateWidget(covariant RequestQueryPage oldWidget) {
    unawaited(loadData());
